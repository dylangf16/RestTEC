...
const calculateTotalPriceUnformatted = () => {
  ...
  const calculateTotalPrice = () => {
    ...
    // Format the total price with a space as the thousand separator
    const formattedTotalPrice = new Intl.NumberFormat('es-CR', { 
