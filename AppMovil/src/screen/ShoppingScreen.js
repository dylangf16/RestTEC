        ...
        <View style={styles.menuContainer}>
          {dishes.map((dish, index) => (
            <View key={index} style={styles.dishContainer}>
              ...
              <Text style={styles.dishDetail}>Rating: {dish.feedback}</Text>
              <Text style={styles.dishDetail}>Precio: ₡{dish.precio_colones}</Text>
              ...
              <View style={styles.buttonContainer}>
                <Button
                  ...
                  onPress={() =>
                    addToCart(dish.id_plato, dish.nombre_plato, dish.precio_colones)
                  }
                />
              </View>
